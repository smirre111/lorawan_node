...
// network.
//static const PROGMEM u1_t NWKSKEY[16] = { 0xb7, 0x6a, 0xae, 0xaa, 0xcf, 0xf7, 0x8d, 0x42, 0x34, 0xfc, 0xed, 0x58, 0x19, 0x6f, 0x21, 0x45 };
static const PROGMEM u1_t NWKSKEY[16] = { 0xDF, 0x01, 0x1B, 0xDD, 0x3C, 0xDE, 0xD5, 0xC9, 0x38, 0x4A, 0x46, 0x96, 0x68, 0xCF, 0xA1, 0x0F };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
//static const u1_t PROGMEM APPSKEY[16] = { 0x7f, 0x14, 0x1f, 0x11, 0x55, 0x46, 0xfd, 0xc0, 0xd4, 0x53, 0xd5, 0xbb, 0x6b, 0xa7, 0x85, 0xbf };
static const u1_t PROGMEM APPSKEY[16] = { 0xF0, 0xDC, 0x71, 0x52, 0xF3, 0x70, 0xE3, 0x8A, 0x8A, 0x72, 0xAC, 0xDE, 0xAF, 0x18, 0x31, 0x87 };
// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x010535b2;
...
#elif defined(CFG_eu433) // EU channel setup
  // Set up the channel used by the Things Network and compatible with
  // our gateway.
  // Setting up channels should happen after LMIC_setSession, as that
  // configures the minimal channel set.
